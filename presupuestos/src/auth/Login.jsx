...
const Login = ({ loginSetter, showLoggedIn }) => {
    ...
    const handleLogin = async () => {
        ...
        if (await login(username, password)) {
            ...
            loginErrorMessage.current.style.display = "block"
        }
    }
  ...
  return (
    <div className='flex flex-col items-center w-[30rem] mx-auto mt-12 p-7 pb-10 bg-white shadow-custom-external-blur rounded-lg'>
        ...
        <div className='flex flex-col w-3/4 mx-auto my-12'>
            ...
            <input ref={usernameInput} type="text" className='rounded-lg py-1 px-2 shadow-custom-internal-blur' placeholder='tuemail@email.com' onKeyDown={handleKeyDown}/>
        </div>
        <div className='flex flex-col w-3/4 mx-auto mb-12'>
            <label className='font-bold text-lg font-museo pb-2'>Contraseña</label>
            <input ref={passwordInput} type="password" className='rounded-lg py-1 px-2 shadow-custom-internal-blur' placeholder='********' onKeyDown={handleKeyDown}/>
        </div>
