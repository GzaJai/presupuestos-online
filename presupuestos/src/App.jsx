...
function App() {
  ...
  return (
    <>
    <div className="w-10/12 mx-auto p-5 pb-10 bg-blue-400 rounded-lg">
      ...
      <div className="flex justify-center space-x-10 pt-[4rem]">
        ...
        <button className="bg-green-600 p-5 mb-10 rounded-lg text-white font-bold text-xl hover:bg-blue-600 hover:duration-150" onClick={done ? printPdf : handleDone}>{done ? "Imprimir" : "Siguiente"}</button>
      </div>
    </>
  )
}
