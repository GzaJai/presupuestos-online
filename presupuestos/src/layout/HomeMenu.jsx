...
import { getBudget } from '../utils/authUtils'
  ...
  return (
    <div className='w-[30rem] h-[20rem] p-[2rem] mx-auto shadow-custom-external-blur text-center rounded'>
        ...
        <nav className="flex flex-col p-4 mt-5 space-y-4 items-center justify-center">
          <Link to="/new-budget" className="flex items-center justify-center w-2/3 h-[2rem] text-white font-medium bg-yui-900 rounded">Presupuestos</Link>
