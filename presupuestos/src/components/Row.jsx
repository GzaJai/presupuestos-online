...
const Row = ({ rowId, saveRow, removeRow, getTableTotal }) => {
  ...
  return (
    <div className="w-full mx-auto text-sm flex gap-[.2rem] py-[.1rem]">
        ...
        <input ref={inputRefProduct} className="h-[2rem] placeholder:text-center flex-1 p-2 rounded border-[1px] border-custom-gray" type="text" placeholder="Producto" onChange={handleOnChange} />
        <input ref={inputRefQuantity} className="h-[2rem] w-[8rem] text-center no-spin p-2 rounded border-[1px] border-custom-gray" type="number" placeholder="Cantidad" onChange={handleOnChange}/>
        <input ref={inputRefPrice} className="h-[2rem] w-[8.5rem] text-center no-spin p-2 rounded border-[1px] border-custom-gray" type="number" placeholder="Precio unitario" onChange={handleOnChange}/>
